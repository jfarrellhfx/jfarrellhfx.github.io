...
My name is Jack Hollis Farrell, and I am an undergraduate student at the University of Toronto studying physics.  Mostly, I am interested in *Condensed Matter Physics*, the theoretical physics of materials --- this wide field includes some of the theory behind Quantum Computers, Superconductors, and more.
 ...
 I was born in Halifax, Nova Scotia, where I went to high school. There, In 2017, I moved to Toronto to start university.


For specifics, please consult my [full CV](/assets/CV.pdf). If you don't need the exhausting detail, find some highlights below!

<details>
<summary>Contact</summary>
<ul>
<li>email &mdash; jack dot farrell at mail.utoronto.ca</li>
</ul>
</details>
